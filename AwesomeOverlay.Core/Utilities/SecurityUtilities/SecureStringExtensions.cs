...
namespace AwesomeOverlay.Core.Utilities.SecurityUtilities
{
    public static class SecureStringExtensions
    {
        /// <summary>
        /// Unsecures a <see cref="SecureString"/> to simple string 
        /// </summary>
        ...
        /*
         * The code below is licensed under a Creative Commons Attribution 4.0 International License.
